...
export default function BusinessAnalystInternPage() {
                ...
                <div style={{ display: "flex", gap: "60px", alignItems: "flex-start" }}>
                    ...
                    <div style={{ width: "200px", flexShrink: 0, position: "sticky", top: "24px", alignSelf: "flex-start" }}>
                        ...
                        <div style={{ marginBottom: "24px", paddingBottom: "24px", borderBottom: "1px solid #eeeeee" }}>
                            ...
                            <p style={{ fontSize: "14px", fontWeight: 500, color: "#111111", margin: 0, fontFamily: "Space Grotesk, sans-serif" }}>Business & Operations</p>
                        </div>
                    ...
                    <div style={{ flex: 1 }}>
                        ...
                        <div style={{ borderBottom: "1px solid #eeeeee", marginBottom: "40px", display: "flex", gap: "32px" }}>
                            <button
                                ...
                                style={{
                                    ...
                                    color: activeTab === "overview" ? "#111111" : "#aaaaaa",
                                    background: "none",
                                    border: "none",
                                    borderBottom: activeTab === "overview" ? "2px solid #111111" : "2px solid transparent",
                                    paddingBottom: "12px",
                                    cursor: "pointer",
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    color: activeTab === "application" ? "#111111" : "#aaaaaa",
                                    background: "none",
                                    border: "none",
                                    borderBottom: activeTab === "application" ? "2px solid #111111" : "2px solid transparent",
                                    paddingBottom: "12px",
                                    cursor: "pointer",
                                    fontFamily: "Space Grotesk, sans-serif",
                                }}
                        ...
                        {activeTab === "overview" && (
                            <div style={{ fontFamily: "Space Grotesk, sans-serif" }}>
                                ...
                                <p style={{ fontSize: "15px", lineHeight: "1.8", color: "#444444", marginBottom: "32px" }}>
                                    We&apos;re looking for a Business Analyst Intern to join us this summer. This isn&apos;t a &quot;make decks in the background&quot; role, you&apos;ll work directly with the founders on things that actually move the needle.
                                </p>
                                ...
                                <ul style={{ fontSize: "15px", lineHeight: "1.8", color: "#444444", marginBottom: "32px", paddingLeft: "20px", listStyleType: "disc" }}>
                                    <li style={{ marginBottom: "8px" }}>Own our social presence - writing and publishing content on LinkedIn, Twitter/X, Instagram, and YouTube; light video/post editing included</li>
                                    <li style={{ marginBottom: "8px" }}>Support our fundraising efforts - helping research VCs and investors, understand term sheets, and prepare materials that move conversations forward</li>
                                    <li style={{ marginBottom: "8px" }}>Dig into market research, competitive landscape, and user insights that shape how we position ConvoSatya</li>
                                    <li style={{ marginBottom: "8px" }}>Work directly with the founders, this isn&apos;t a &quot;make decks in the background&quot; role</li>
                                </ul>

                                <h2 style={{ fontSize: "16px", fontWeight: 600, color: "#111111", marginBottom: "12px" }}>What We&apos;re Looking For</h2>
                                <ul style={{ fontSize: "15px", lineHeight: "1.8", color: "#444444", marginBottom: "32px", paddingLeft: "20px", listStyleType: "disc" }}>
                                    <li style={{ marginBottom: "8px" }}>Curious, proactive, and don&apos;t wait to be told what to do</li>
                                    <li style={{ marginBottom: "8px" }}>Can write clearly and think on your feet</li>
                                    <li style={{ marginBottom: "8px" }}>Some familiarity with startups, fundraising, or social media content is a plus - not required</li>
                                    <li style={{ marginBottom: "8px" }}>Students or recent grads welcome; all backgrounds considered</li>
                                </ul>
                                ...
                                <button
                                    onClick={() => setActiveTab("application")}
                                    style={{ width: "100%", padding: "16px", backgroundColor: "#111111", color: "#ffffff", fontSize: "15px", fontWeight: 600, border: "none", borderRadius: "8px", cursor: "pointer", fontFamily: "Space Grotesk, sans-serif", marginTop: "8px" }}
                                >
                                    Apply for this Job
                                </button>
                                ...
                                <form onSubmit={handleSubmit} encType="multipart/form-data">
                                    <div style={{ fontFamily: "Space Grotesk, sans-serif" }}>
                                        ...
                                        <div style={{ marginLeft: "40px" }}>
                                            <button
                                                type="submit"
                                                style={{ width: "100%", padding: "16px", backgroundColor: "#111111", color: "#ffffff", fontSize: "15px", fontWeight: 600, border: "none", borderRadius: "8px", cursor: "pointer", fontFamily: "Space Grotesk, sans-serif" }}
                                            >
                                                Submit Application
                                            </button>
