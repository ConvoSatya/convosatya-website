                    ...
                    <div className="flex justify-between items-center py-5 group-hover:bg-gray-50 transition-colors rounded-lg px-2" style={{ borderBottom: "1px solid #eeeeee" }}>
                        <div>
                            ...
                            <p className="m-0 mt-1" style={{ fontSize: "13px", color: "#888888", fontFamily: "IBM Plex Mono, monospace" }}>
                                Remote · Summer 2026 · Internship
                            </p>
                        </div>
                        <span className="group-hover:text-[#18BFA9] transition-colors" style={{ fontSize: "20px", color: "#cccccc" }}>→</span>
                    </div>
                </Link>

                {/* Data & Engineering */}
                <p style={{ fontSize: "11px", fontWeight: 600, letterSpacing: "2px", textTransform: "uppercase", color: "#aaaaaa", marginBottom: "8px", marginTop: "32px", fontFamily: "Space Grotesk, sans-serif" }}>
                    Data &amp; Engineering
                </p>

                <Link href="/careers/data-engineer-intern" className="group" style={{ textDecoration: "none" }}>
                    <div className="flex justify-between items-center py-5 group-hover:bg-gray-50 transition-colors rounded-lg px-2" style={{ borderBottom: "1px solid #eeeeee" }}>
                        <div>
                            <p className="m-0 group-hover:text-[#18BFA9] transition-colors" style={{ fontSize: "16px", fontWeight: 600, color: "#111111", fontFamily: "Space Grotesk, sans-serif" }}>
